...
<main>
  ...
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="#" class="nav-link">Crear Registro</a></li>
        <li class="nav-item"><a href="#" class="nav-link">Consultar</a></li>
  ...
  <button class="btn btn-outline-light btn-lg" type="button">Crear Registro</button>
  <button class="btn btn-outline-light btn-lg" type="button">Consultar Registro</button>
  <button class="btn btn-outline-light btn-lg" type="button">Actualizar Registro</button>
  <button class="btn btn-outline-light btn-lg" type="button">Borar Registro</button>
</div>
      ...
      <div class="col-md-6 mt-2">
         <div class="h-100 p-5 text-bg-primary rounded-3">
          ...
          <div class="d-grid gap-2">
  <button class="btn btn-outline-light btn-lg" type="button">Resumen</button>
  <button class="btn btn-outline-light btn-lg" type="button">Exportar</button>
  <button class="btn btn-outline-light btn-lg" type="button">Puntaje Test Caldas</button>
