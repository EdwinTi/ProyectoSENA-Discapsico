  ...
  <head>
   ...
   <body class="d-flex align-items-center py-4 bg-body-tertiary">
            ...
            <main class="form-signin w-100 m-auto">
                 <form class="from-sing" method="post"action="Controlador_db">
                     <div class="container">
    ...
    <div class="form-floating">
      <input type="email" name="txtuser" class="form-control" id="floatingInput" placeholder="name@example.com">
    ...
    <button class="btn btn-primary w-100 py-2" type="submit" name="accion" value="Ingresar">Sign in</button>
